...
{
    public class DuckDBQueryFilter : IQueryFilter
    {
        /// <summary>
        /// 数据列
        /// </summary>
        ...
        /// <returns>SQL</returns>
        public static string BuildWhereSql(List<IQueryFilter> parameters)
        {
        ...
        /// <param name="parameters">参数集合</param>
        /// <returns>SQL</returns>
        public static string BuildJoinSql(List<IQueryFilter> parameters)
        {
            var sql = new StringBuilder();
        ...
        public List<int> Filter(Array source) => throw new NotImplementedException();
