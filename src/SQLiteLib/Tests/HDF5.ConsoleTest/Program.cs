...
namespace HDF5.ConsoleTest
{
    ...
    {
        public static int RowCount = 50000;
        public static int ParaCount { get; set; } = 20;
        ...
        static void WriteLongTable()
        {
            ...
            for (int i = 0; i < ParaCount; i++)
            {
                ...
                for (int j = 0; j < RowCount; j++)
                    values[j] = 314.012345678901234567890123456789;
        ...
        static void WriteLargeCompounds()
        {
            ...
            //Hdf5.WriteLargeCompounds(groupId, "PARA_DETAIL", tests, default);
